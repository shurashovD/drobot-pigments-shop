const Agent = () => {
    return (
		<div className="h-100">
			<div className="text-center text-uppercase text-white p-4 bg-dark">для АГЕНТОВ</div>
			<div className="text-center p-4 py-6 d-flex flex-column h-100" style={{ backgroundColor: "#f1f1f1" }}>
				<p>
					...
					<span className="white-space">"АГЕНТ DROBOT Pigments"</span>
				</p>
				...
				<div className="mt-auto text-center">
					<a
						href="https://docs.google.com/forms/d/1HII26FtVe2jHRMrdo1qXfVsJBb9URU2p8P61Q0l-0n8/edit"
						target="_blank"
