		...
		<Container className="mb-6">
			...
			<Accordion className="custom-accordion" flush>
				...
				<Accordion.Item eventKey="5">
					...
					<Accordion.Body>
						<p>
							Только товар, приобретенный по полной фиксированной цене, подлежит возврату. К сожалению, мы не не можем принять от Вас
							товар, купленный со скидкой, предоставляемой по специальной акции. Товары, приобретенные с учетом накопительной скидки,
							подлежат возврату или обмену в обычном порядке. DROBOT PIGMENTS SHOP: возврат товаров в других случаях
						</p>
					</Accordion.Body>
				</Accordion.Item>
			</Accordion>
