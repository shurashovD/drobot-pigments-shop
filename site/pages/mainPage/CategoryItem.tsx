...
const CategoryItem: FC<IProps> = ({ category }) => {
    ...
    return (
		<div className="position-relative" ref={container}>
			...
			<NavLink
				className="w-100 p-2 px-xl-4 text-uppercase text-primary bg-dark position-absolute bottom-0 start-0 end-0 d-flex align-items-center category-card__label"
