					...
					<Row xs={2} className="g-4">
						<Col style={{ minHeight: "98px" }}>
							<a
								...
								className="bg-secondary d-flex flex-column justify-content-evenly align-items-center p-2 p-md-3 px-md-4 h-100"
							>
								<span className="text-center text-uppercase mb-2">Масштабная колористика Drobot pigments</span>
						...
						<Col style={{ minHeight: "98px" }}>
							<a
								...
								className="bg-secondary d-flex flex-column justify-content-evenly align-items-center p-2 p-md-3 px-md-4 h-100"
							>
								<span className="text-center text-uppercase mb-2">каталог пигментов</span>
								<span className="text-muted text-uppercase text-center">Скачать</span>
							</a>
						</Col>
						<Col style={{ minHeight: "98px" }}>
							<a
								href="http://"
								className="bg-dark text-secondary d-flex flex-column justify-content-center align-items-center p-2 p-md-3 px-md-4 h-100"
							>
						...
						<Col style={{ minHeight: "98px" }}>
							<a
								...
								className="bg-dark text-secondary d-flex flex-column justify-content-center align-items-center p-2 p-md-3 px-md-4 h-100"
							>
								<span className="text-center text-uppercase">алгоритm подбора</span>
