...
const AddVideoComponent: FC<{ productId: string }> = ({ productId }) => {
    const [uploadVideo, { isLoading }] = useAddWorksVideoMutation()
    ...
    return (
		<div className="d-flex">
			<label className={classNames({ "d-none": isLoading }, "btn btn-outline-primary position-relative")}>
				...
				<input type="file" className="position-absolute invisible p-0" onChange={handler} accept="video/*" />
			</label>
