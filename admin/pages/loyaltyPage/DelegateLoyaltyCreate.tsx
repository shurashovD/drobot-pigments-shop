...
import { useCreateDelegateLoyaltyMutation } from "../../application/loyalty.service"
...
const DelegateLoyaltyCreate: FC<IProps> = ({ disabled }) => {
    const [state, setState] = useState({ lowerTreshold: '', percentValue: '' })
	const [create, { isLoading, isSuccess }] = useCreateDelegateLoyaltyMutation()
...
export default DelegateLoyaltyCreate