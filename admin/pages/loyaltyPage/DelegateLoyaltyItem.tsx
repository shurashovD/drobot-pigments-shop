...
import { IDelegateDiscount } from '../../../shared/index'
import { useDeleteDelegateLoyaltyMutation, useUpdateDelegateLoyaltyMutation } from "../../application/loyalty.service"
import ButtonComponent from "../../components/ButtonComponent"

interface IProps extends IDelegateDiscount{
	disabled: boolean
}

const DelegateLoyaltyItem: FC<IProps> = ({ id, disabled, lowerTreshold, percentValue }) => {
    const [state, setState] = useState({ lowerTreshold: lowerTreshold.toString(), percentValue: percentValue.toString() })
    const [update, { isLoading }] = useUpdateDelegateLoyaltyMutation()
    const [remove, { isLoading: removeLoading }] = useDeleteDelegateLoyaltyMutation()
...
export default DelegateLoyaltyItem